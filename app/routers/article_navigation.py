...
async def article_navigation(request: Request, lang: str = "ja"):
    if lang in ["ja", "en", "zh"]:
        df = request.app.state.profile_df
        id = request.app.state.rec_actress_id
        ...
        return templates.TemplateResponse(
            f"html/{lang}/article-navigation.html",
            {
                ...
                "rec_actress_link": df.loc[df["id"]==id, "affiliateURL"].tolist()[0],
                "rec_actress_img": df.loc[df["id"]==id, "imageURL"].tolist()[0],

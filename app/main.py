...
from app.routers import index, img_rec, mov_rec, img_rec_result, article_navigation, article, regularly_tweet, regularly_actress_tweet, sitemap
...
#app.include_router(regularly_actress_tweet.router, tags=["html"])
